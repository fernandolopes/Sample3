...
<body>
	...
	<div class="row">
        ...
        Título: <input type="text" name="titulo" value="${dao.getLivro(param.id).getTitulo()}"/>
        Gênero: <input type="text" name="genero" value="${dao.getLivro(param.id).getGenero()}"/>
        Autores: <input type="text" name="autores" value="${dao.getLivro(param.id).getAutores()}"/>
        Ano: <input type="number" step="any" name="ano" value="${dao.getLivro(param.id).getAno()}"/>
        Editora: <input type="text" name="editora" value="${dao.getLivro(param.id).getEditora()}"/>
